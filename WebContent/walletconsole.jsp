					...
					<div class="12u">
						...
						<header id="header">
							<nav id="nav">
								...
								<a href="./walletconsole.jsp" class="current-page-item">Wallet Console</a>
								<a href="./settings.jsp">Settings</a>
								<a href="./" ><%=coin.getTickerSymbol() %> Available: <%=coin.getAvailableBalance()%> <%=coin.getTickerSymbol() %></a>
							</nav>
						</header>
				...
				<div class="row main-row">
					<div class="4u" style="width: 100%;">
						<section id="recentTransactions">
							<h2>Wallet Console Input and Response</h2>
						</section>
				...
				<div class="row">
					<div class="8u">
						...
						<section>
							...
							<p>Please join us in our bitcointalk forum thread.</p>
							<p>Find us on social media</p>
							<p>Or email us, at support@blockchaintechs.com</p>
						</section>
					...
					<div class="4u">
						...
						<section>
							<footer class="controls">
								<a href="http://blockchaintechs.com/" class="button"><img width="300px" src="images/staker_1024.png"/></a>
							</footer>
						</section>
